...
- [ ] Página inicial
- [ ] Catálogo
- [ ] Página individual do SEL-000001
- [ ] Página Sobre
- [ ] Navegação entre páginas

## Imagens

- [ ] Frente carregando corretamente
- [ ] Verso carregando corretamente
- [ ] Card carregando corretamente
- [ ] Nenhuma serrilha cortada
- [ ] Selo centralizado
- [ ] Margens visuais equilibradas
- [ ] Imagem sem deformação
- [ ] Alternância frente/verso funcionando
...
- [ ] País correto
- [ ] Ano correto
- [ ] Valor facial correto
- [ ] Série correta
- [ ] Dados técnicos visíveis
- [ ] Catálogos separados corretamente
- [ ] Níveis de confiança exibidos
- [ ] Estado do exemplar exibido
- [ ] Contexto histórico exibido
- [ ] Fontes exibidas
- [ ] Campos pendentes identificados
- [ ] Nenhum valor undefined, null ou NaN aparecendo
...
- [ ] Botões reais na alternância frente/verso
- [ ] aria-pressed atualizado
